...
# : 기본키(PK) 설정 시 자동 생성
# - 테이블 당 단 하나만 생성 가능
# - 자동 정렬 기능을 포함: 지정한 열(기본키 설정 열)을 기준으로 자동 정렬
...
# 1) 회원 아이디(member_id, PK) 컬럼에 자동으로 '클러스터형 인덱스'가 생성
