...
# : 각 숫자형 데이터 타입의 시작을 음수가 아닌 0부터 시작
...
/*
    ...
    cf) char: character 문자
        ...
        cf) 다량의 텍스트 데이터 형식
			a) text 형식: 1 ~ 약65000 바이트
				longtext 형식: 1 ~ 약 42억 바이트
			
            b) blob (binory long object): 이미지, 동영상 등의 데이터
				1 ~ 약65000바이트
				longblob: 1 ~ 약42억 바이트
*/
...
/*
    ...
    cf) MySQL에서는 boolean타입이 존재하지만, 실제(내부적으로)는 tinyint(1)로 처리
