...
/*
    ...
    3) 약어 사용: 가능하면 사용 지양
        ...
        ex) addr(address), amt(amount), qty(quantity), tel_no(phone_number)
...
/*
    ...
    복수형 명사 권장: users, products, orders / user_reviews, order_items 등
...
#DB명: bookhub.db, senior_db, body_laboratory_db 등