...
create table `contacts`(
	contact_id int primary key, -- PK값은 not null 지정하지 않아도 자동 지정
...
-- 	(1, '양현석', '1234'),
-- 	(2, '양현석', null),
--     -- Error Code: 1048. Column 'phone' cannot be nul
-- 	(3, '성재원', '1234');

/*
	6. default 제약 조건
    : 테이블의 열의 값이 명시적으로 제공되지 않는 경우 사용되는 기본값
...
values
	(1, '노트북', 3),
	(2, '스마트폰', null),# null값 입력시 null값이 지정(기본값 지정 X)
	(3, '태블릿', 2);
