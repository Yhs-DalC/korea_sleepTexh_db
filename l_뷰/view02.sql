...
# cf) 조회 시 컬럼(열) 이름에 공백이 있을 경우 `(백틱)으로 지정
...
# cf) 테이블 생성 시 '존재하는 테이블을 경우 생성하지 않는' 옵션
...
-- values
-- 	('IVE', '아이브', '경기');
# >> v_member가 참조하는 원본 테이블의 npt null 컬럼이 뷰에 포함되어 있지 않으면 삽입 불가
-- insert into v_member
-- values
-- 	('IVE', '아이브', 7, '경기', null, null, 171, '2022-01-01');
